          ...
          <div className="footerPro__brand" ref={brandRef}>
            <div className="footerPro__brandContent">
              ...
              <div className="footerPro__brandText">
                ...
                <p className="footerPro__tagline">Python Developer</p>
              </div>
            </div>
          </div>
            ...
            <div className="fCard__head">
              ...
              <div>
                ...
                <p className="fCard__desc">
                  Рассматриваю backend и AI-проекты с понятными задачами и адекватной инженерной культурой
                </p>
              </div>
            </div>
            <p className="fCard__text">
              Комфортно работаю в командах, где важны ответственность, прозрачная коммуникация и качество реализации.
              Интересны задачи, в которых нужно довести продукт до стабильного production-результата, а не просто закрыть тикет.
            </p>
          </article>
          ...
          <article className="fCard" data-accent="violet">
            <div className="fCard__head">
              ...
              <div>
                ...
                <p className="fCard__desc">Подход к работе</p>
              </div>
            </div>
            <ul className="fList">
              <li>Сначала уточняю требования и фиксирую ожидаемый результат</li>
              <li>Думаю о надежности и поддерживаемости решений с первого этапа</li>
              <li>Аккуратно работаю с интеграциями, состояниями и edge-case сценариями</li>
              <li>Довожу задачи до рабочего результата и проверяемого качества</li>
            </ul>
          </article>
